...
export const blazorCultures = [
  {
    ...
    notificationsSectionDescription: "Get notified on this device, also when the app is not open.",
  ...
  },
  {
    ...
    notificationsSectionDescription: "Få en notifikation på denne enhed, også når appen ikke er åben.",
    notificationsOnThisDevice: "Notifikationer på denne enhed",
    sendTestNotification: "Send en testnotifikation",
