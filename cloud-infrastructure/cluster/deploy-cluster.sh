...
export ENTRA_OAUTH_CLIENT_ID
export ENTRA_OAUTH_CLIENT_SECRET
export MITID_DOMAIN
export MITID_CLIENT_ID
export MITID_CLIENT_SECRET
export MITID_VERIFICATION_ENABLED
export MITID_LOGIN_ENABLED
export PUSH_VAPID_PUBLIC_KEY
export PUSH_VAPID_PRIVATE_KEY
export PUSH_NOTIFICATION_SUBJECT
